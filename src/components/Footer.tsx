...
export function Footer() {
  ...
  return (
    <footer className="bg-stone-900 dark:bg-[#09090b] text-stone-300 dark:text-zinc-300 font-sans border-t border-stone-800 dark:border-zinc-900 pt-16 pb-12 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <p className="text-xs text-stone-400 dark:text-zinc-400 leading-relaxed font-sans max-w-sm">
              {lang === "bn"
          ...
          <div className="lg:col-span-2 space-y-3">
            ...
            <ul className="space-y-2 text-xs text-stone-400 dark:text-zinc-400">
              <li>
          ...
          <div className="lg:col-span-4 space-y-3">
            ...
            <p className="text-xs text-stone-400 dark:text-zinc-400">Get 10% off your first order & stay updated.</p>
            ...
            <form onSubmit={handleSubscribe} className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-2.5 bg-stone-800 dark:bg-zinc-900 border border-stone-700 dark:border-zinc-800 rounded-lg text-xs text-white outline-none focus:border-red-500 font-sans"
              />
              <button
                type="submit"
        ...
        <div className="pt-8 border-t border-stone-800 dark:border-zinc-900 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-stone-500 dark:text-zinc-500">
          <p>© 2026 RAIB Bags. All rights reserved.</p>

          <div className="flex items-center gap-4">
            <a href="https://instagram.com" target="_blank" rel="noreferrer" className="p-2 bg-stone-800 dark:bg-zinc-900 hover:bg-stone-700 dark:hover:bg-zinc-800 rounded-full text-stone-400 dark:text-zinc-400 hover:text-white transition">
            ...
            <a href="https://facebook.com" target="_blank" rel="noreferrer" className="p-2 bg-stone-800 dark:bg-zinc-900 hover:bg-stone-700 dark:hover:bg-zinc-800 rounded-full text-stone-400 dark:text-zinc-400 hover:text-white transition">
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
