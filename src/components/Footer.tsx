...
export function Footer() {
  ...
  return (
    <footer className="bg-[#09090b] text-zinc-300 font-sans border-t border-zinc-900 pt-16 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        
        {/* Main 4-Column Footer Grid matching Image 2 */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-4 space-y-3">
            ...
            <p className="text-xs text-zinc-400">Get 10% off your first order & stay updated.</p>
            ...
            <form onSubmit={handleSubscribe} className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-2.5 bg-zinc-900 border border-zinc-800 rounded-lg text-xs text-white outline-none focus:border-red-500 font-sans"
              />
              <button
                type="submit"
                className="px-4 py-2.5 bg-amber-600 hover:bg-amber-500 text-zinc-950 font-bold text-xs rounded-lg transition flex items-center justify-center cursor-pointer"
                title="Subscribe"
              >
        ...
        {/* Bottom Copyright & Social Bar matching Image 2 */}
        <div className="pt-8 border-t border-zinc-900 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-zinc-500">
          ...
          <div className="flex items-center gap-4">
            <a href="https://instagram.com" target="_blank" rel="noreferrer" className="p-2 bg-zinc-900 hover:bg-zinc-800 rounded-full text-zinc-400 hover:text-white transition">
            ...
            <a href="https://facebook.com" target="_blank" rel="noreferrer" className="p-2 bg-zinc-900 hover:bg-zinc-800 rounded-full text-zinc-400 hover:text-white transition">
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
