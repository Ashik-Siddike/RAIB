...
export default function FaqPage() {
  ...
  const faqs = [
    ...
    {
      q: "ব্যাগগুলো কি ১০০% খাঁটি ইতালিয়ান লেদার? (Authenticity)",
      qEn: "Are RAIB bags 100% Genuine Italian Leather?",
      a: "হ্যাঁ, RAIB-এর প্রতিটি ব্যাগ ১০০% Tuscan ফুল-গ্রেইন ইতালিয়ান লেদার থেকে হাতে প্রস্তুত করা হয় এবং সাথে ১৮K গোল্ড-প্লেটেড হার্ডওয়্যার সংযুক্ত থাকে। প্রতিটি ব্যাগের সাথে কারিগরি সার্টিফিকেট ও প্রিমিয়াম ডাস্ট ব্যাগ দেওয়া হয়।",
      icon: ShieldCheck,
    },
    {
