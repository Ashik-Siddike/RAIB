...
export default function Home() {
  ...
  return (
    <div className="space-y-0 w-full overflow-x-hidden bg-zinc-950 text-white">
        ...
        <section className="py-16 sm:py-24 bg-zinc-950 border-b border-zinc-900">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
            ...
            <div className="text-center space-y-2">
              <span className="text-xs font-bold text-red-500 uppercase tracking-widest block font-sans">
                FEATURED TODAY
              </span>
            ...
            <div className="text-center pt-4">
              <Link
                ...
                className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-zinc-400 hover:text-white transition group"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 text-center">
            <div className="p-4 space-y-2">
              <Award className="w-6 h-6 text-red-500 mx-auto" />
              <h4 className="text-xs font-bold text-white uppercase font-serif">100% Genuine Italian Leather</h4>
              <p className="text-[11px] text-zinc-500">Handcrafted by master artisans</p>
            </div>

            <div className="p-4 space-y-2">
              <Truck className="w-6 h-6 text-red-500 mx-auto" />
              <h4 className="text-xs font-bold text-white uppercase font-serif">Cash on Delivery</h4>
              <p className="text-[11px] text-zinc-500">Fast home delivery across BD</p>
            </div>

            <div className="p-4 space-y-2">
              <RotateCcw className="w-6 h-6 text-red-500 mx-auto" />
              <h4 className="text-xs font-bold text-white uppercase font-serif">7-Day Easy Exchange</h4>
            ...
            <div className="p-4 space-y-2">
              ...
              <h4 className="text-xs font-bold text-white uppercase font-serif">18K Gold-Plated Hardware</h4>
